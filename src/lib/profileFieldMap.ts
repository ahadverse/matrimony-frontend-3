...
export const PROFILE_FIELD_TABS: Record<string, EditProfileTab> = {
  ...
  nationality: 'basic',
  relativeName: 'basic',
  educationDetails: 'basic',
  workingSector: 'basic',
  professionDetails: 'basic',
  fatherStatus: 'personal',
  motherStatus: 'personal',
  brothersMarried: 'personal',
  brothersUnmarried: 'personal',
  sistersMarried: 'personal',
  sistersUnmarried: 'personal',
  familyDetails: 'personal',
  weightKg: 'personal',
  physicalDetails: 'personal',
  religiousValue: 'lifestyle',
  familyValues: 'lifestyle',
  diet: 'lifestyle',
  smoke: 'lifestyle',
};
